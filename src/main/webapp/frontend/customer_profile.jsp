...
<%--&lt;%&ndash;              <div class="col"><b>First Name:</b></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col">${loggedCustomer.firstname}</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;            <div class="row">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col"><b>Last Name:</b></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col">${loggedCustomer.lastname}</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
            ...
            <div class="row">
              <div class="col"><b>Address Line :</b></div>
              <div class="col">${loggedCustomer.address}</div>
            </div>

<%--&lt;%&ndash;            <div class="row">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col"><b>Address Line 2:</b></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col">${loggedCustomer.addressLine2}</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;            <div class="row">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col"><b>State:</b></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="col">${loggedCustomer.state}</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
            ...
            <div class="row">
              ...
              <div class="col">${loggedCustomer.country}</div>
            </div>
